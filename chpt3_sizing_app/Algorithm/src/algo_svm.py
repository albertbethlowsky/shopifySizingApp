...
def getresults(kern, X_test, y_test, X_train, y_train):
    ...
    svm_model = LinearSVC(C=1000, multi_class='crammer_singer')
    start = time()
    ...
    s = 'kernel='+kern
    return [[name,'LinearSVC+CrammerSinger', accuracy, rmse, mae, scores, kscore_stnd_dev, time_libsvm],df]
